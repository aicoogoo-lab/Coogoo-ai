...
- واجهة مستخدم أمامية (UI) تعرض الواجهة الزجاجية السائلة
- خدمة الملفات الثابتة (CSS, JS, images)
- تكامل كامل مع SAMA
"""

import os  # <-- تمت إضافة هذا الاستيراد لقراءة متغيرات البيئة
...
# إذا لم يوجد المتغير، يتم استخدام قيمة افتراضية تحذيرية
...
# ============================================================
# 2.5) واجهة المستخدم الأمامية (Frontend UI)
# ============================================================

@app.route("/ui")
def serve_ui():
    """عرض الواجهة الأمامية الجميلة لسماء"""
    try:
...
if __name__ == "__main__":
    ...
    print("   - GET  /ui                  → الواجهة الأمامية (HTML)")
